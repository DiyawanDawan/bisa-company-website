...
export default function Partners() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-[#135122] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
        ...
        <ScrollReveal variant="fadeUp" delay={0.2} className="flex justify-center pt-2">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-white/50 text-white text-sm font-semibold rounded-full hover:bg-white hover:text-[#135122] transition-colors duration-200"
          >
